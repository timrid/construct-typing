...
class FormatField(Construct[ParsedType, BuildTypes]):
    ...
    @t.overload
    def __init__(
        self: FormatField[int, int], endianity: str, format: FORMAT_INT
    ) -> None: ...
    @t.overload
    def __init__(
        self: FormatField[float, float], endianity: str, format: FORMAT_FLOAT
    ) -> None: ...
    @t.overload
    def __init__(
        self: FormatField[t.Any, t.Any], endianity: str, format: str
    ) -> None: ...
...
class Struct(Construct[Container[t.Any], t.Optional[t.Dict[str, t.Any]]]):
    def __init__(
        self, *subcons: Construct[t.Any, t.Any], **subconskw: Construct[t.Any, t.Any]
    ) -> None: ...
...
class Hex(Adapter[SubconParsedType, SubconBuildTypes, ParsedType, BuildTypes]):
    ...
    @t.overload
    def __new__(
        cls, subcon: Construct[t.Dict[K, V], BuildTypes]
...
class IfThenElse(
    t.Generic[ThenParsedType, ThenBuildTypes, ElseParsedType, ElseBuildTypes],
    Construct[
...
) -> IfThenElse[ThenParsedType, ThenBuildTypes, None, None]: ...
